    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(blank=True, upload_to='books/cover', verbose_name='图书封面')),
                ('brief', models.TextField(blank=True, default='', verbose_name='图书简介')),
                ('word_count', models.IntegerField(default=0, verbose_name='总字数')),
                ('copyright', models.CharField(blank=True, max_length=100, verbose_name='版权信息')),
                ('rank', models.FloatField(blank=True, default=0, verbose_name='评分')),
                ('price', models.FloatField(default=0, verbose_name='价格')),
                ('read_count', models.IntegerField(blank=True, default=0, verbose_name='阅读人数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=15, unique=True, verbose_name='类别')),
                ('category_type', models.IntegerField(blank=True, choices=[(1, '一级类别'), (2, '二级类别')], null=True, verbose_name='类别级别')),
            ],
            options={
                'verbose_name': '图书类别',
